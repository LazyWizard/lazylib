...
fun Vector2f.resize(length: Float) = VectorUtils.resize(this, length, this)
fun Vector2f.clampLength(maxLength: Float) = VectorUtils.clampLength(this, maxLength, this)
fun Vector2f.clampLength(minLength: Float, maxLength: Float) = VectorUtils.clampLength(this, minLength, maxLength, this)
